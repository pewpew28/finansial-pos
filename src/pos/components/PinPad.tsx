  ...
  return (
    <div className="flex flex-col items-center gap-6 select-none">
        ...
        {KEYS.map((key, i) => {
          ...
          return (
            <button
              ...
              className="h-16 flex items-center justify-center rounded-2xl bg-white border border-gray-200 text-gray-900 text-xl font-bold active:scale-90 active:bg-violet-50 active:border-violet-300 transition-all duration-100 shadow-sm hover:border-violet-200"
            >
              {key}
            </button>
          );
      ...
      {onBack && (
        <button
          onClick={onBack}
          className="flex items-center gap-2 text-sm text-gray-500 font-semibold mt-2 active:opacity-60"
        >
          <ArrowLeft size={14} />
          Kembali
        </button>
